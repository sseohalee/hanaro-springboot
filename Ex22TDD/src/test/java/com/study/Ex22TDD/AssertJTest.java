...
public class AssertJTest {
    ...
    void test1(){
        ...
        assertThat(user.getName().isEmpty()).isFalse();
        assertThat(user.getNickname().isEmpty()).isTrue();
    }
    ...
    void test5(){
        ...
        String input = "abc";
        //when then
        assertThatThrownBy(()-> input.charAt(input.length()+1))
    ...
    void test7(){
        ...
        assertThat(3.14d)
                ...
                .isGreaterThan(3)
                .isLessThan(4)
                .isEqualTo(3, offset(1d)) // 일의 자리수까지 비교
    ...
    public void test8(){
        // given when
        User user = new User("hong","theif","bank@gmail.com");
