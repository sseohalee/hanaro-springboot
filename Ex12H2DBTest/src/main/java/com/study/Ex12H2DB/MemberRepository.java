...
public interface MemberRepository extends JpaRepository<MemberEntity, Long> {
    ...
    @Query(value = "SELECT * FROM member WHERE joindate BETWEEN '2023-03-01' AND '2023-03-31'",
            nativeQuery = true)
    List<MemberEntity> findByJoindate();
    ...
    @Query(value = "UPDATE member SET user_name = :username, user_pw = :userpw where user_id = :userid",
            nativeQuery = true)
    int updatePractice(String userid, String username, String userpw);
