...
public class MemberRepositoryTest extends Ex12H2DbApplicationTests {
    ...
    public void findByPw(){
        boolean isExist = memberRepository.existsByUserPw("1234");
    ...
    public void findByDate(){
        List<MemberEntity> list =
                memberRepository.findByJoindate();
    ...
    @DisplayName("연습3")
    public void dupl(){
        boolean isExist = memberRepository.existsByUserId("lee");
    ...
    public void updatePractice(){
        int result = memberRepository.updatePractice("tom", "마이클", "3456");
        assertEquals(1, result);

        Optional<MemberEntity> member =
                memberRepository.findById(2L);
        assertEquals("마이클", member.get().getUserName() );
    ...
    public void delete(){
        ...
        assertEquals(null, oldMember.get());
    }
